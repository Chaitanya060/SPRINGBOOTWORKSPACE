...
public interface FacultyCourseMappingRepository extends CrudRepository<FacultyCourseMapping, Integer>//in this crud operation we are used many to one so that why we will use this
{
